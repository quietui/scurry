...
/** @description A simple animation that rotates in and out horizontally. */
export function rotateX(options?: Partial<QuietAnimationOptions>): QuietTransitionAnimation {
