...
/** @description A sci-fi animation that warps elements through a dimensional gateway. */
export function portal(_options?: Partial<QuietAnimationOptions>): QuietTransitionAnimation {
  return {
    enter: {
      keyframes: [
