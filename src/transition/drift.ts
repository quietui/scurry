...
/** @description A gentle animation that makes elements float into view with a subtle blur effect. */
export function drift(options?: Partial<QuietAnimationOptions>): QuietTransitionAnimation {
