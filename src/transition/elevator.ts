...
/** @description A smooth animation that lifts elements into view like an ascending elevator. */
export function elevator(_options?: Partial<QuietAnimationOptions>): QuietTransitionAnimation {
  return {
    enter: {
      keyframes: [
